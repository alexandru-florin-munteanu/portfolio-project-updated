        ...
        <div className="header d__flex">
          ...
          <div className="navigation">
            <ul className="navigation__navbar">
              ...
              <a href="#Tech">
                <li className="nav__items mx__15">Tech</li>
              </a>
              <a href="#Portfolio">
                <li className="nav__items mx__15">Portfolio</li>
              </a>
              <a href="#Next">
                <li className="nav__items mx__15">What's next</li>
              </a>
        ...
        <div className="container">
          <div className="home__content">
            <div className="home__meta">
              ...
              <h2 className="home__text pz__10">Hi, I’m Alex Munteanu</h2>
              <h3 className="home__text sweet pz__10">
                Aspiring Web Developer
              </h3>
              <h4 className="home__text pz__10">based in Romania.</h4>
            </div>
          </div>
        </div>
      </div>
