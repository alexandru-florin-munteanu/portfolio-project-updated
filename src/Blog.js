        ...
        <div className="blog__container">
          <div className="blog__item">
            <div className="project__box pointer relative">
              ...
              <div className="Blog__meta ">
                <h5 className="blog__text">Food and Nutrition App</h5>
                <h4 className="blog__text">Currently planning.</h4>
          ...
          <div className="blog__item">
            <div className="project__box">
              ...
              <div className="Blog__meta">
                <h5 className="blog__text">Bankist Website</h5>
                <h4 className="blog__text">Adding new features </h4>
                <a
          ...
          <div className="blog__item">
            <div className="project__box">
              ...
              <div className="Blog__meta">
                <h5 className="blog__text">Transylvania 6 Days</h5>
                <h4 className="blog__text">Currently working on.</h4>
                <a
